    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-3xl border border-gray-200 shadow-lg p-8 text-center">
        ...
        <button
          ...
          className="mt-8 inline-flex items-center justify-center w-full rounded-2xl bg-gradient-to-r from-teal-600 to-pink-600 px-6 py-4 text-white font-semibold hover:shadow-lg transition-all"
        >
          Connect wallet
        </button>
        ...
        <div className="mt-6 rounded-3xl bg-teal-50 p-4 text-left text-sm text-gray-700">
          ...
          <p className="mt-2">Your wallet will unlock quiz access and reward tokens.</p>
        </div>
      </div>
    </div>
  );
